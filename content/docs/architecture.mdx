...
- **Fork the generators.** The source generators live in [the Spiderly repo](https://github.com/filiptrivan/spiderly) under MIT. Copy the ones you use into your codebase and evolve them on your own schedule.
