...
| File storage variables (`BlobStorageConnectionString`, `S3BucketName`, `CloudinaryCloudName`, etc.) | Depends on your storage provider. See [File Storage — Provider Setup](/docs/file-storage#provider-setup). |
