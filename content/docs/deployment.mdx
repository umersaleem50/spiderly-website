...
| `AppSettings__Spiderly.Shared__TelegramBotToken`, `AppSettings__Spiderly.Shared__TelegramChatId` | Telegram error notifications. See [Set Up Telegram Notifications](/docs/set-up-telegram-notifications). |
