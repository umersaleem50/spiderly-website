...
| `AppSettings:Spiderly.Security:ExternalProviders:0:ClientId` | `AppSettings__Spiderly.Security__ExternalProviders__0__ClientId` |
...
| `AppSettings__Spiderly.Security__ExternalProviders__0__Code`, `AppSettings__Spiderly.Security__ExternalProviders__0__ClientId`, `AppSettings__Spiderly.Security__ExternalProviders__0__ClientSecret` | External auth provider config (one entry per provider). See [Set Up Google Authentication](/docs/set-up-google-authentication). |
